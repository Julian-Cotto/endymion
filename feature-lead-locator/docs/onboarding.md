# Lead Locator Developer Onboarding

## Purpose

This repository contains the `Lead Locator` feature.
...
{
  "authorization": {
    "requiredPermissions": ["lead-locator.view"],
    "requiredFlags": ["lead-locator.enabled"]
  }
}
```
