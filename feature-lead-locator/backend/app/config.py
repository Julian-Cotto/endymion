...
class Settings(BaseSettings):
    ...
    service_name: str = "Lead Locator Service"
    feature_key: str = "lead-locator"
    api_base_path: str = "/api/leads"
    ...
    auth_default_dev_roles_raw: str = "lead-locator.view"
    ...
    auth_required_permissions_raw: str = "lead-locator.view"
