# Reports Layering Runbook

## Purpose

This runbook explains how to operate, validate, troubleshoot, and support the `Reports Layering` feature.
...
```bash
curl http://localhost:<backend-port>/api/reports/health
```
...
```text
AUTH_DEFAULT_DEV_ROLES_RAW does not include reports-layering.view
